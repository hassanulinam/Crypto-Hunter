...
export const CoinsListUrl = (currency: string | unknown) =>
  `${COINS_API_DOMAIN}/coins/markets?vs_currency=${currency}&order=market_cap_desc&per_page=100&page=1&sparkline=false`;

export const SingleCoinUrl = (id: number) => `${COINS_API_DOMAIN}/coins/${id}`;
...
export const TrendingCoinsUrl = (currency: string | unknown) =>
